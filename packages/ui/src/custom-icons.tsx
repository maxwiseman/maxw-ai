...
export const AutopilotIcon = (props: Omit<HTMLProps<SVGElement>, "ref">) => {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M721.396 687.196c-45.85-58.057-106.083-100.338-195.933-100.338-214.88 0-343.915 207.975-343.915 373.071H.445c0-248.384 201.735-554.173 525.018-554.173 169.001 0 279.135 82.912 359.586 198.223l.832 1.196c-62.129 12.891-118.449 41.723-164.485 82.021Zm478.394 543.43c46.633 58.232 107.337 102.603 194.605 102.603 214.894 0 343.915-220.01 343.915-373.3h181.102c0 230.595-201.75 554.402-525.017 554.402-164.202 0-277.033-85.686-358.624-200.584 62.043-13.287 118.212-42.49 164.019-83.121Z" />
      <circle cx={960.39} cy={960.39} r={247.721} />
      <path d="M960.159.318C1489.91.318 1920 430.409 1920 960.159 1920 1489.91 1489.91 1920 960.159 1920 430.409 1920 .318 1489.91.318 960.159.318 430.409 430.409.318 960.159.318Zm0 193.802c422.789 0 766.04 343.25 766.04 766.039s-343.251 766.04-766.04 766.04-766.039-343.251-766.039-766.04S537.37 194.12 960.159 194.12Z" />
      <path
        d="m131.7 1337.38 454.32 145.467-324.317 313.517L131.7 1337.38ZM1788.62 582.934 1334.3 437.467l324.317-313.518 130.003 458.985Z"
        style={{
          stroke: "#030000",
          strokeWidth: 5,
        }}
...
export const xAIIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    enableBackground="new 201.61 51.91 438.67 491.45"
    viewBox="201.61 51.91 438.67 491.45"
    width="1em"
    height="1em"
    {...props}
  >
...
export const QwenIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    fillRule="evenodd"
    height="1em"
    style={{
